 ...
 */
class ASTARTEQT4SDKSHARED_EXPORT Operation : public QObject
{
    Q_OBJECT
...
protected:
    ...
    explicit Operation(ExecutionOptions options, QObject *parent = 0);
    explicit Operation(OperationPrivate &dd, ExecutionOptions options, QObject *parent = 0);
